...
from .views import random_redirect, ProductDetail, ProductListView, ProductDelete
...
urlpatterns = [
    ...
    # path('product-detail/<slug:slug>/rating-system', ..., name='myList/productDetailRating),
